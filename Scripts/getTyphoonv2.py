...
TIDEPATH = r'C:\Users\Windows User\Desktop\Work\Fieldworks\AlbayOutputs\Tides\Caloy2006'
#TIDEPATH = r'C:\Users\Windows User\Desktop\Work\Fieldworks\AlbayOutputs\Tides'
...
#    print prov    
    #Path to tide text files
#    aa = os.path.split(root)
#    TARGETPATH = os.path.abspath(os.path.join(TIDEPATH,'..','%s'%aa[1][:-4].lower()))
    # Path where output (surge + tide) will be saved
#    if not os.path.isdir(TARGETPATH):
#        target = os.mkdir(TARGETPATH)#r'C:\Users\Windows User\Desktop\Work\Fieldworks\SorsogonOutputs\reming'    
#    else:
