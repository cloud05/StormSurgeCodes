...
#    while True:
#        try:
    mainDir = r'C:\Users\Windows User\Desktop\Work\tide\TIDAL DATA\NOAH\SURIGAO 1987-2012'#raw_input("Enter the root directory: ")#raw_input("Enter the station folder you want to compare: ")
...
#                        tides = tideForecast(121.86,13.53,startDate,60,720,8)
...
##                        plt.legend()
##                        plt.show()
##                        print "No file: " + path +'\{0}{1}.png'.format(z,yr)                                    
