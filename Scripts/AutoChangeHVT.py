...
def automate():
    ...
    print "new orig: " + newoutflowPath
    time = 6#raw_input("Input the time of the HVT file you want to use(i.e. 6 or 12): ")
    height = 2#input("Input the minimum height of the HVT file you want to use(i.e. 2,3,4 or 5 only!: ")
    x = len(e)
    change = e[x-2]   
    print change
    ...
    while height < 6:
        ...
        print "changed: " + change_newoutflowPath
